    ...
    <div className="home-container">
      ...
      <div className="main-content">
        ...
        <div className="tablerender-container">
          ...
          <div className="drone-knowmore-card">
            ...
            <br></br>
            <p>
            The DrIFT dataset addresses the critical need for robust visual drone detection 
            under real‑world domain shifts by offering fourteen systematically varied 
            domains—encompassing changes in viewpoint, synthetic vs. real imagery, seasonal 
            variation, and adverse weather—and uniquely supplying pixel‑wise background 
            segmentation maps for background‑aware evaluation. To complement this rich dataset, 
            we introduce MCDO‑map, an efficient Monte Carlo Dropout–based uncertainty metric, 
            and leverage it within an uncertainty‑aware unsupervised domain adaptation framework 
            that selectively adapts high‑confidence regions. Together, these contributions enable 
            more reliable drone detection across diverse environments, closing the gap between 
            controlled training conditions and the complexities of real‑world deployment.
            </p>
            <br></br>
            <p>
